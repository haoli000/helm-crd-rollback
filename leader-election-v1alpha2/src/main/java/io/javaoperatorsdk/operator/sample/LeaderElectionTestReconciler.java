...
import io.javaoperatorsdk.operator.sample.v1alpha2.LeaderElection;
import io.javaoperatorsdk.operator.sample.v1alpha2.LeaderElectionStatus;
...
public class LeaderElectionTestReconciler implements Reconciler<LeaderElection> {
  ...
  public UpdateControl<LeaderElection> reconcile(
    ...
    resource.getStatus().setAddedField("XXXXXX");
